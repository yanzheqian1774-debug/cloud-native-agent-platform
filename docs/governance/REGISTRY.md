...
| --- | --- | --- | --- | --- | --- | --- | --- |
| S5-REL-027 | Portfolio and Governance State Reconciliation / REL | `ACTIVE / AUTHORIZED`; Checkpoint A — Bounded Governance Reconciliation | `IN_PROGRESS`; Human-allocated REL ID; governance reconciliation only | Baseline and durable main `b244fa5da3e670fa754278a0559da1a3049fb05a`; branch `codex/s5-rel-027-governance-reconciliation`; exactly five authorized governance/evidence/portfolio paths; no downstream task allocated or authorized | Human Portfolio Sequence Decision: `GOVERNANCE_RECONCILIATION_FIRST`; Human Review Gate: `PENDING` | `HUMAN_CONFIRMED / REPOSITORY_NATIVE / DERIVED`; ID: `HUMAN_ALLOCATED` | Human S5-REL-027 Review Gate; then Human Portfolio Sequence Gate |
