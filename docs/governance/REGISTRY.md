...
| --- | --- | --- | --- | --- | --- | --- | --- |
| S5-REL-027 | Portfolio and Governance State Reconciliation / REL | `REVIEW / AUTHORIZED`; Checkpoint B — Independent Governance Consistency and Merge Readiness; active, not merged, not closed | `PASS_WITH_CONSTRAINTS / READY_FOR_HUMAN_MERGE_GATE`; Human-allocated REL ID; governance reconciliation only | Baseline and durable main `b244fa5da3e670fa754278a0559da1a3049fb05a`; branch `codex/s5-rel-027-governance-reconciliation`; Draft PR #68 open/unmerged; Checkpoint A head `d8d1ca66f573800944ea9db655f65cc6695e00d3`; exactly five authorized governance/evidence/portfolio paths; exact-candidate CI run `33045129213` succeeded; no downstream task allocated or authorized | Human Portfolio Sequence Decision: `GOVERNANCE_RECONCILIATION_FIRST`; Human Review Gate: `PASS_WITH_CONSTRAINTS`; Human Merge Gate: `PENDING` | Human decisions: `HUMAN_CONFIRMED`; branch/content: `REPOSITORY_NATIVE`; PR/CI: `PR_NATIVE`; reconciliation: `DERIVED`; ID: `HUMAN_ALLOCATED` | Human S5-REL-027 Merge Gate; after reconciliation, Human Portfolio Sequence Gate |
