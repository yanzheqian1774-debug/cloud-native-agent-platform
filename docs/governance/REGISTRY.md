...
| --- | --- | --- | --- | --- | --- | --- | --- |
| S5-ARCH-012 | User Intervention, Preference, Feedback and Governed Optimization Boundary / ARCH | `REVIEW / AUTHORIZED`; Checkpoint A — Architecture Decision and G2 Boundary | `PASS_WITH_CONSTRAINTS / READY_FOR_HUMAN_S5_ARCH_012_REVIEW_GATE`; architecture candidate only; implementation not started | Durable baseline `0ea21ab628561f2e1e5e1a08651e9ef5a9b8fc79`; Governed Successor and Cold Optimization Boundary; exactly five architecture/evidence/governance paths; v0.2 preference/candidate preview remains `NOT_APPLIED`; no public API, CRD, Graph, dependency, Workflow, Portfolio, Knowledge implementation, Demo, Runtime, Recovery, Certification, or Release change | Human Architecture Decision: `APPROVED_WITH_CONSTRAINTS`; Human Review Gate: `PENDING` | decision and ID: `HUMAN_CONFIRMED / HUMAN_ALLOCATED`; candidate content: `REPOSITORY_NATIVE / NOT_DURABLE_MAIN`; PR/CI: `PENDING` | Human S5-ARCH-012 Review Gate; no implementation or downstream Session authorized |
| S5-ARCH-011 | Product Intent, Dynamic Work Composition, Role and Knowledge Consumption Boundary / ARCH | `CLOSING / AUTHORIZED`; Checkpoint B — Independent Architecture Safety and Merge Readiness | `PASS_WITH_CONSTRAINTS / READY_FOR_HUMAN_S5_ARCH_011_MERGE_GATE`; architecture candidate only; implementation not started | Durable baseline `a0d82be4387f5706129ee6676ad5965b42a3efdb`; Checkpoint A head `761ba46345f01e30c0d8f72b84722621ece80d40`; Draft PR #72; exactly five architecture/evidence/governance paths; one linear bounded safety correction; no public API, CRD, Graph, dependency, workflow, Portfolio, Demo, Runtime, MCP, Knowledge implementation, Recovery, Certification, or Release change | Human Architecture Decision and Review Decision: `APPROVED_WITH_CONSTRAINTS / APPROVED_WITH_CONSTRAINTS`; Human Merge Gate: `PENDING` | decisions and task ID: `HUMAN_CONFIRMED / HUMAN_ALLOCATED`; candidate content: `REPOSITORY_NATIVE / NOT_DURABLE_MAIN`; PR/CI: `PR_NATIVE / PENDING_FINAL_HEAD` | Human S5-ARCH-011 Merge Gate; no implementation or downstream Session authorized |
