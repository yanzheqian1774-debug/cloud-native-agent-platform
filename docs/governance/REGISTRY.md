...
| S5-ARCH-018 | Bounded Product Continuity Persistence Architecture / ARCH G2 | `ACTIVE / AUTHORIZED / CHECKPOINT_A / FINAL_RECONCILED_PROPOSAL_READY_FOR_HUMAN_REVIEW` | Architecture/governance only; PostgreSQL is primary deployment persistence for new v0.2.2–v0.2.4 product-continuity domains; existing Evidence SQLite has a bounded transition; final reconciliation defines backend-governed resource operations, protected published history, reference-aware deletion, Knowledge purge and non-sensitive tombstones; no implementation, public API/CRD, State Plane, Tenant, HA, multi-region or production authority | Exact baseline `a6ec463a365b5f12e8fb64b0b84772a3beb0ae15`; branch `codex/s5-arch-018-bounded-product-continuity-persistence`; [decision](../../architecture/s5/v0.2/S5-ARCH-018-BOUNDED-PRODUCT-CONTINUITY-PERSISTENCE-V1.md); [Evidence](../evidence/s5/v0.2/s5-arch-018/README.md); prior SQLite-default proposal superseded | PostgreSQL direction: `ACCEPTED_IN_PRINCIPLE`; final deletion/resource-management reconciliation and amended architecture acceptance, merge, Durable Integration: `PENDING` | amendment/reconciliation: `HUMAN_CONFIRMED / REPOSITORY_NATIVE`; final decision: `PROPOSED` | Human review of final reconciliation; no REL/implementation starts automatically |
