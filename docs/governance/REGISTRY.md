...
| S5-ARCH-007 | v0.2 Core Representation & API Gate / ARCH | `REVIEW / AUTHORIZED` | `PASS_WITH_CONSTRAINTS / CORE_REPRESENTATION_G2_CANDIDATE`; Checkpoint A | Source: S5-ARCH-005, S5-ARCH-006, S5-PLAN-001, S5-REL-007; baseline `040f324359c6db16ee52c55b8f367d1cc4157de9`; branch `codex/s5-arch-007-core-representation-api-gate` | G2-01–G2-12: `PENDING_HUMAN_G2_GATE`; A1 recommended only; no schema/API/CRD change | `REPOSITORY_NATIVE / HUMAN_DECISION_PENDING` | Human S5-ARCH-007 G2 Representation/API Gate |
