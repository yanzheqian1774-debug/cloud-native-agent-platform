...
| --- | --- | --- | --- | --- | --- | --- | --- |
| S5-GOV-003 | v0.2.2, v0.2.3 and v0.2.4 Authority and Persistence Governance Reconciliation / GOV | `ACTIVE / AUTHORIZED`; Checkpoint A | `GO_WITH_CONDITIONS`; governance reconciliation only; no implementation, deployment, release, architecture implementation, certification or public Contract authority | Exact baseline `474b19e7bf32a342d93b4b891f6c7a799b9261b6`; branch `codex/s5-gov-003-v022-v024-authority-persistence-reconciliation`; [exec plan](../exec-plans/active/S5-GOV-003-V022-V024-AUTHORITY-PERSISTENCE-RECONCILIATION.md); [Evidence](../evidence/s5/v0.2/s5-gov-003/README.md) | Product definitions, persistence direction, ordering and reconciliation scope: `HUMAN_CONFIRMED`; review, Durable Integration and closure: `PENDING` | authority/allocation: `HUMAN_CONFIRMED`; baseline/CI: `REPOSITORY_NATIVE / PR_NATIVE`; reconciliation: `IN_PROGRESS` | Human review and Durable Integration decision; no downstream task starts automatically |
| S5-ARCH-018 | consolidated v0.2.2–v0.2.4 persistence G2 / ARCH candidate | `CANDIDATE_ONLY / UNALLOCATED / NOT_ACTIVE` | Candidate identifier only; no architecture Session, decision or implementation authority exists | Named by S5-GOV-003 solely for a possible subsequent consolidated persistence G2 | Allocation and Architecture Gate: `NOT_HELD` | `HUMAN_CONFIRMED_CANDIDATE_ONLY` | Separate Human allocation and G2, if pursued |
