...
| --- | --- | --- | --- | --- | --- | --- | --- |
| S5-ARCH-013 | Definition Publication and Matchability Authority / ARCH | `ACTIVE / ARCHITECTURE_COMPLETE / REVIEW_READY / AWAITING_DURABLE_INTEGRATION`; Checkpoint C terminal architecture Evidence and handoff preparation | `PASS_WITH_CONSTRAINTS / CHECKPOINT_C`; internal architecture only; no merge, durable integration, Human closure, implementation, or downstream authority | Baseline `a485c5f3fb016629bf17c0fcd47c0ecd3d4c6fa3`; branch `codex/s5-arch-013-definition-publication-matchability-authority`; authority S5-PLAN-003, S5-ARCH-011, and Human-accepted ARCH-DISCUSS-004 Option B; exactly five architecture/Evidence/governance paths; trusted catalog, deterministic snapshot, exact handoff, reuse, and validation matrix audited; commit/push/Draft PR/exact-head CI pending at repository-recording time | Checkpoint 0, A, B, and C: `PASS_WITH_CONSTRAINTS`; terminal Evidence review, REL allocation, merge, integration, and closure: `PENDING` | decisions: `HUMAN_CONFIRMED`; candidate: `REPOSITORY_NATIVE`; Git/PR/CI facts recorded only after they exist | Human S5-ARCH-013 Terminal Evidence Review and REL Allocation Decision; S5-IMPL-030 remains frozen |
