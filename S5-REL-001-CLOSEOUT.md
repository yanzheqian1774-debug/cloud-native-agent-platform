...
The pre-close checkpoint recorded `LIFECYCLE: CLOSING`,
`AUTHORIZATION: AUTHORIZED`, and `RESULT: READY_TO_CLOSE`. The subsequent Human
Close Confirmation established the following permanent final session state.
