...
# The trusted browser surface is a separate application and remains disabled
# unless every accepted authority dependency is configured. The private app
# above keeps its existing service-to-service entry points.
