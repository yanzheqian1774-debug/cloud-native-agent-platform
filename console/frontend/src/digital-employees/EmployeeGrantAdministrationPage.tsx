...
export function AuthorizationAdministrationPage() {
  ...
  const domainLabel = ({S5_324_RESOURCE_REVIEW:"资源审核与发布",WORKBENCH_EMPLOYEE_LIFECYCLE:"数字员工配置",S5_324_NATIVE_READONLY:"隔离 Native 准备与执行",PROBLEM_DRAFT_ASSISTANCE:"AI 草稿辅助",PROBLEM_DRAFT_MODEL_INVOKE:"模型调用",CONTINUE_PROBLEM_READ:"业务问题读取",WORKBENCH_SUCCESS_CRITERIA:"成功标准"} as Record<string,string>)[request?.purpose??""]??"精确权限";
