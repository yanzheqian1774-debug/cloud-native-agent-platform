...
function EvidencePage() {
  ...
  if(parsed.state==="INVALID"||!parsed.context.resourceId)return <main className="assembly-page"><ControlledState kind="not-found" title="缺少证据上下文" detail="请从所选精确对象进入证据视图；当前链接未携带受支持的资源身份、修订与摘要。" action={<Link className="primary-link" to="/catalog">返回能力与资源</Link>}/></main>;
