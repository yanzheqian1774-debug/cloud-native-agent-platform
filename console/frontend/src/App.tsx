...
import { ProblemWorkspacePage } from "./problems/ProblemWorkspacePage";
import { PlanningPage } from "./planning/PlanningPage";
import { PlanningEntry } from "./planning/PlanningEntry";
...
import { EmployeeGrantAdministrationPage } from "./digital-employees/EmployeeGrantAdministrationPage";
...
import { EvidenceCenterPage } from "./evidence/EvidenceCenterPage";
...
function App() {
  ...
  if (supplierQualityLive) {
    return <BrowserRouter><SelectedExecutionContext><ConsoleShell><Routes><Route path="/" element={<Navigate to="/dashboard" replace />} /><Route path="/dashboard" element={<ProductDashboardPage/>}/><Route path="/catalog" element={<ResourceCatalogPage/>}/><Route path="/digital-employees" element={<DigitalEmployeesPage/>}/><Route path="/authorization-admin" element={<EmployeeGrantAdministrationPage/>}/><Route path="/attention" element={<AttentionPage/>}/><Route path="/relationships" element={<UnifiedRelationshipsPage/>}/><Route path="/problems" element={<ProblemPlanningPage/>} /><Route path="/work" element={<ProblemWorkspacePage/>} /><Route path="/work/plan" element={<PlanningEntry/>}/><Route path="/work/planning/:proposalId" element={<PlanningPage/>}/><Route path="/agents" element={<AgentWorkbenchPage/>} /><Route path="/skills" element={<SkillWorkbenchPage/>} /><Route path="/mcp" element={<McpWorkbenchPage/>} /><Route path="/knowledge" element={<KnowledgeWorkbenchPage/>} /><Route path="/workflow-definitions" element={<WorkflowWorkbenchPage/>} /><Route path="/runtime-profiles" element={<RuntimeProfileWorkbenchPage/>} /><Route path="/workspace" element={<PlanningDirectoryPage kind="workspace"/>} /><Route path="/product" element={<PlanningDirectoryPage kind="workspace"/>} /><Route path="/product-view" element={<ProductViewPage/>}/><Route path="/technical-view" element={<TechPage/>}/><Route path="/evidence" element={<EvidencePage/>}/><Route path="/outcomes" element={<OutcomeCenterPage/>}/><Route path="/applications" element={<ApplicationMarketPage/>}/><Route path="/agent-center" element={<AgentCenterPage/>}/><Route path="/permissions" element={<PermissionCenterPage/>}/><Route path="/security" element={<SecurityCenterPage/>}/><Route path="/operations" element={<OperationsCenterPage/>}/><Route path="/models" element={<ModelCenterPage/>}/><Route path="/usage" element={<UsageCenterPage/>}/><Route path="/settings" element={<SettingsPage/>}/><Route path="/help" element={<HelpCenterPage/>}/><Route path="/tasks" element={<PlanningDirectoryPage kind="plans"/>} /><Route path="/employees" element={<DigitalEmployeesPage/>} /><Route path="/resources" element={<ResourceCatalogAlias/>} /><Route path="/runtime" element={<PlanningDirectoryPage kind="runtime"/>} /><Route path={technicalPath} element={<PlanningDirectoryPage kind="technical"/>} /><Route path="*" element={<Navigate to="/dashboard" replace />} /></Routes></ConsoleShell></SelectedExecutionContext></BrowserRouter>;
  }
