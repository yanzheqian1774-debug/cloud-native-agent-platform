...
function KnowledgeWorkbench({refresh}:{refresh:()=>void}) {
  ...
  const revisionCreatedAt = shownRevision?.createdAt;
  const aggregateActivityAt = value?.facts?.at(-1)?.recordedAt;
